...
public:
  ...
  [[__nodiscard__]] _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX20 iterator
  begin() _NOEXCEPT _LIBCPP_LIFETIMEBOUND {

    return __make_iter(0);
  }
  [[__nodiscard__]] _LIBCPP_HIDE_FROM_ABI
      _LIBCPP_CONSTEXPR_SINCE_CXX20 const_iterator
      begin() const _NOEXCEPT _LIBCPP_LIFETIMEBOUND {

    return __make_iter(0);
  }
  [[__nodiscard__]] _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX20 iterator
  end() _NOEXCEPT _LIBCPP_LIFETIMEBOUND {
  ...
  [[__nodiscard__]] _LIBCPP_HIDE_FROM_ABI
      _LIBCPP_CONSTEXPR_SINCE_CXX20 const_reverse_iterator
  ...
  [[__nodiscard__]] _LIBCPP_HIDE_FROM_ABI
      _LIBCPP_CONSTEXPR_SINCE_CXX20 reference
      operator[](size_type __n) _LIBCPP_LIFETIMEBOUND {
    _LIBCPP_ASSERT_VALID_ELEMENT_ACCESS(__n < size(), "vector<bool>::operator[] index out of bounds");
    return __make_ref(__n);
  }
  [[__nodiscard__]] _LIBCPP_HIDE_FROM_ABI
      _LIBCPP_CONSTEXPR_SINCE_CXX20 const_reference
  ...
  [[__nodiscard__]] _LIBCPP_HIDE_FROM_ABI
      _LIBCPP_CONSTEXPR_SINCE_CXX20 const_reference
      back() const _LIBCPP_LIFETIMEBOUND {
...
#  endif
  ...
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX20 iterator insert(
      const_iterator __position, const value_type &__x) _LIBCPP_LIFETIMEBOUND;
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX20 iterator
  insert(const_iterator __position, size_type __n,
         const value_type &__x) _LIBCPP_LIFETIMEBOUND;
  template <class _InputIterator, __enable_if_t<__has_exactly_input_iterator_category<_InputIterator>::value, int> = 0>
